        ...
        <section className="hidden md:flex flex-1 bg-slate-50 p-12 flex-col justify-between relative overflow-hidden">
          <div className="z-10">
            <div className="flex items-center gap-2 mb-8">
              ...
              <span className="text-2xl font-display font-black text-primary tracking-tighter">Namma Health Card</span>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Link to="/recovery" className="text-xs font-bold text-primary hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
