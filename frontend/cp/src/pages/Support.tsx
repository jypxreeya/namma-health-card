           ...
           <div className="relative rounded-[40px] overflow-hidden min-h-[400px] flex flex-col justify-end p-10 group">
             ...
             <div className="relative z-10 space-y-6">
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <button onClick={() => navigate('/feedback')} className="bg-white/10 backdrop-blur-xl border border-white/20 text-white h-16 px-6 rounded-2xl font-bold hover:bg-white/20 active:scale-95 transition-all">
                    Submit Feedback
                  </button>
                </div>
             </div>
