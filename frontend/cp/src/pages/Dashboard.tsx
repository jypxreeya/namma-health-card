    ...
    <div className="min-h-screen bg-surface pb-32">
      <header className="bg-white sticky top-0 z-50 border-b border-zinc-100 h-16 flex items-center justify-between px-4">
        <div className="flex items-center gap-3">
          ...
          <span className="text-lg font-extrabold text-zinc-900 font-display">Namma Health</span>
        </div>
        <button onClick={() => navigate('/notifications')} className="relative p-2 text-zinc-500 hover:bg-zinc-50 rounded-full">
      ...
      <main className="max-w-md mx-auto px-4 pt-4 space-y-6">
        ...
        <section className="space-y-4">
          <div className="flex justify-between items-center">
            ...
            <button onClick={() => navigate('/history')} className="text-primary font-bold text-sm">View All</button>
          </div>
