      ...
      <div className="w-full max-w-md px-6 -mt-12 relative z-10 flex flex-col gap-6 mx-auto">
        <div className="text-left space-y-2">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-display font-extrabold text-xl tracking-tight text-primary">Namma Health</span>
          </div>
          <h1 className="font-display font-bold text-3xl text-on-surface">Login to Namma Health</h1>
          <p className="text-on-surface-variant font-medium">Access your health card and family benefits</p>
        </div>

        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); navigate('/otp'); }}>
